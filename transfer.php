        ...
        <nav class="navbar navbar-expand-sm  navbar-toggler navbar-light" style="background-color:transparent; background-color:#fff; opacity:1;"> 
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02" style="float:right;">
                ...
                <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="viewcustomers.php" style="color:black;font-weight:1em;font-family: 'Roboto Condensed', sans-serif">
                            <div style="padding-left:20px;font-family: 'Roboto Condensed', sans-serif" >
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="transferrecords.php" style="color:black;font-family: 'Roboto Condensed', sans-serif;font-weight:1em;">
